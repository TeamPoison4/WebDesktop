                        ...
                        <div class="ibox-content">
                            ...
                            <div class="col-lg-10"><input type="text" placeholder="cedula" class="form-control"> 
                                ...
                                <div class="form-group"><label class="col-lg-2 control-label">Apellido:</label>
                                    ...
                                    <div class="col-lg-10"><input type="correo" placeholder="Apellido" class="form-control"></div>
                                </div>
                                
                                 <div class="form-group"><label class="col-lg-2 control-label">Direccion:</label>

                                    <div class="col-lg-10"><input type="correo" placeholder="Direccion" class="form-control"></div>
                                </div>
                                
                                <div class="form-group"><label class="col-lg-2 control-label">Correo:</label>

                                    <div class="col-lg-10"><input type="correo" placeholder="Correo" class="form-control"></div>
                                </div>
                                
                                 <div class="form-group"><label class="col-lg-2 control-label">Telefono:</label>

                                    <div class="col-lg-10"><input type="correo" placeholder="Telefono" class="form-control"></div>
                                </div>
